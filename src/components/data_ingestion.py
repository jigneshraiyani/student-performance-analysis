...
class DataIngestionConfig:
    train_data_path: str = os.path.join(FOLDER_NAME, 'train.csv')
    test_data_path: str = os.path.join(FOLDER_NAME, 'test.csv')
    raw_data_path: str = os.path.join(FOLDER_NAME, 'data.csv')
